...
public class five_square_gameview extends View {

    private static final String TAG = "five_square_view";
    boolean[][] vertical_line_state = new boolean[5][5];
    boolean[][] horizontal_line_state = new boolean[5][5];
    ...
    public five_square_gameview(Context context) {
        super(context);
    }

    public five_square_gameview(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public five_square_gameview(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float cx = getWidth() / 2f - 400, cy = getHeight() / 2f - 400;
        for (int i = 0; i < 5; i++) {
            for (int j = 0; j < 5; j++) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            if (x_touch <= getWidth() / 2f + 400 && y_touch <= getHeight() / 2f + 400) {
