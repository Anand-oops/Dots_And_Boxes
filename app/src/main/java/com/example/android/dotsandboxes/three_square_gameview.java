...
public class three_square_gameview extends View {

    private static final String TAG = "three_square_gameview";
    ...
    boolean[][] vertical_line_state = new boolean[3][3];
    boolean[][] horizontal_line_state = new boolean[3][3];
    Paint dots = new Paint();

    Paint text1= new Paint();
    Paint text2=new Paint();

    public three_square_gameview(Context context) {
        super(context);
    }

    public three_square_gameview(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public three_square_gameview(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
                            ...
                            if (!vertical_line_state[j][i]) {
                                ...
                                if (i - 1 >= 0) {
                                    ...
                                    if (horizontal_line_state[j][i - 1] && vertical_line_state[j][i] && horizontal_line_state[j + 1][i - 1] && vertical_line_state[j][i - 1]) {
                                        ...
                                        box_holder.add(new Box(cx - 15, cy + 15, cx - 300 + 15, cy + 300 - 15, color));
                                        player_no++;
                                        player_no %= 2;
                                        flag = 0;
                                    }
